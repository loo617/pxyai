...
--> statement-breakpoint
CREATE INDEX "idx_admin_id_key" ON "admin_user" USING btree ("admin_id");--> statement-breakpoint
CREATE INDEX "idx_api_key_key" ON "api_key" USING btree ("key");--> statement-breakpoint
CREATE INDEX "idx_api_key_open_user_id" ON "api_key" USING btree ("open_user_id");--> statement-breakpoint
CREATE INDEX "idx_model_logs_model" ON "model_logs" USING btree ("model");--> statement-breakpoint
CREATE INDEX "idx_model_logs_open_user_id" ON "model_logs" USING btree ("open_user_id");--> statement-breakpoint
CREATE INDEX "idx_model_logs_provider_code" ON "model_logs" USING btree ("provider_code");--> statement-breakpoint
CREATE INDEX "idx_open_user_id" ON "open_user" USING btree ("open_user_id");--> statement-breakpoint
CREATE INDEX "idx_recharge_records_open_user_id" ON "recharge_records" USING btree ("open_user_id");--> statement-breakpoint
CREATE INDEX "idx_user_balances_open_user_id" ON "user_balances" USING btree ("open_user_id");